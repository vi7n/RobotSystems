...
class Picarx(object):
    ...
    def __init__(self, 
        ...
        self.cali_dir_value = 0 #self.config_flie.get("picarx_dir_motor", default_value="[1,1]")
        self.cali_dir_value = 0 #[int(i.strip()) for i in self.cali_dir_value.strip("[]").split(",")]
